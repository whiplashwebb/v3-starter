			...
			<div class="section">
				<div class="content">
					<blockquote>
						...
						<p>
							The system is built on top of <a
								href="https://oruga.io/documentation/"
								target="_blank"
							>Oruga</a> and <a
								href="https://bulma.io/documentation/"
								target="_blank"
							>Bulma</a>, each of which contain a wealth of components and options. This page mostly shows components from Oruga but there are some css-only components represented from Bulma. This page does <strong>not</strong> show every available component or every variant of the components. Please have a look at the Oruga and Bulma documentation to learn more about the wider options available.
						</p>
						<p>
							<strong>Pro tip:</strong> At the time of this writing Oruga is still a young framework and it's docs are missing some details. However, it is the successor to <a
								href="https://buefy.org/documentation"
								target="_blank"
							>Buefy</a>, a much more established framework with excellent docs. Since most Oruga components have been adapted from Buefy, checking out the Buefy docs can help fill in holes.
						</p>
					</blockquote>
				</div>
			</div>
			...
			<style-guide-section title="Tags">
				<style-guide-subsection>
					<div class="content">
						<blockquote>
							<p>
								Tags currently don't exist in Oruga, only in Bulma. It's a bit unclear why but I suspect it's because there's so simple a component doesn't really accomplish much. Personally I think this would make sense.<br> Read the <a
									href="https://bulma.io/documentation/elements/tag/"
									target="_blank"
								>Bulma Docs</a> to learn more.
							</p>
					...
					<div class="buttons">
						...
						>
							<o-button
								...
								outlined
							>
								<span class="is-capitalized">{{ variant }}</span> Tooltip &nbsp;
							</o-button>
						</o-tooltip>
					</div>
				</style-guide-subsection>
