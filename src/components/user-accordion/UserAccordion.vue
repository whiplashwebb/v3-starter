	...
	<div class="user-accordion">
			...
			<template #trigger="props">
				<div class="user-accordion-header">
					<div class="user-accordion-header__main">
						<div class="user-accordion-header__title">
							{{ currentUser.full_name }}
						</div>
						<div class="user-accordion-header__role">
							{{ currentUser.role }}
						</div>
					</div>
					<o-icon
		...
		>
			<template #trigger="props">
				<div class="user-accordion-header">
					<div class="user-accordion-header__main">
						<div class="user-accordion-header__label">
							Customer:
						</div>
						<div class="user-accordion-header__title">
							{{ currentCustomer ? currentCustomer.name : 'All' }}
						</div>
					</div>
					<o-icon
						class="user-accordion__header-icon"
			...
			<template #trigger="props">
				<div class="user-accordion-header">
					<div class="user-accordion-header__main">
						...
						<div class="user-accordion-header__title">
							{{ currentWarehouse ? currentWarehouse.name : 'All' }}
						</div>
					</div>
					<o-icon
						class="user-accordion__header-icon"
